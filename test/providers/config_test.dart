...
void main() {
  ...
  group('ThemeSetting provider', () {
    test('default value is dark mode', () {
      ...
      expect(value.appStyle, AppStyle.clashParty);
    });

    test('can update state', () {
      container
          .read(themeSettingProvider.notifier)
          .update((_) => const ThemeProps(appStyle: AppStyle.fluent));
      expect(container.read(themeSettingProvider).appStyle, AppStyle.fluent);
    });
  });
  ...
  group('ProxiesStyleSetting provider', () {
    test('default values', () {
      ...
      expect(value.sortType, ProxiesSortType.none);
      expect(value.iconStyle, ProxiesIconStyle.standard);
    });
