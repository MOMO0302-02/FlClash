                            ...
                            : LayoutBuilder(
                                ...
                                builder: (_, constraints) {
                                  return Dismissible(
                                    ...
                                    // 不用 Material 的 Card + elevation：它的
                                    // 阴影带 surfaceTint 染色，在纯黑底上会把
                                    // 卡片染出一层蓝，和别处的卡片不是一个东西。
                                    // 统一走 tokens：圆角 + 那圈白色高光边 + 自带阴影。
                                    child: DecoratedBox(
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(
                                          context.styleTokens.cardRadius,
                                        ),
                                        boxShadow:
                                            context.styleTokens.cardShadow,
                                      ),
                                      child: Container(
