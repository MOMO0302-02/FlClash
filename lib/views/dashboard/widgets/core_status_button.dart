        ...
        child: coreStatus == CoreStatus.connected
            ? IconButton.filled(
                ...
                style: IconButton.styleFrom(
                  // 用统一的成功色，不再 harmonizeWith：那个是把外来色往主色
                  // 方向拧，四种风格主色不同就拧出四种绿；而下面那个分支用的又是
                  // 另一个 greenAccent——同一个"已连接"在同一个按钮里两种绿。
                  backgroundColor: AppStyleTokens.success,
            ...
            : FilledButton.icon(
                ...
                style: FilledButton.styleFrom(
                  ...
                  backgroundColor: switch (coreStatus) {
                    ...
                    CoreStatus.connected => AppStyleTokens.success,
                ...
                icon: SizedBox(
                  ...
                  child: switch (coreStatus) {
                    CoreStatus.connecting => Padding(
                      ...
                      child: HeroSpinner(color: context.colorScheme.onPrimary),
                    ),
