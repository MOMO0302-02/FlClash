...
String _$proxiesActionsStateHash() =>
    r'59b35157164733c59ecdbf8ac2746e4c2b6719c1';
...
String _$genColorSchemeHash() => r'da36c9edca8242d319f56a0692fd591b20cef839';
...
String _$sharedStateHash() => r'd90d8169b11678c7674340a13334f5c9f1a79df0';
...
@ProviderFor(smartOptionsState)
final smartOptionsStateProvider = SmartOptionsStateProvider._();
...
final class SmartOptionsStateProvider
    extends $FunctionalProvider<SmartOptions, SmartOptions, SmartOptions>
    with $Provider<SmartOptions> {
  /// Smart 的全部下发参数，含运行时的网络类型。
  ///
  /// 为什么不直接用 `appSettingProvider.smartOptions`：「仅 Wi-Fi 更新」那道闸要看
  /// **当前是不是 Wi-Fi**，那是运行时状态，不在设置里。把它并进来还有一个好处——
  /// 网络类型一变，这个 provider 就变，`CoreManager` 那条监听会自动重新下发配置，
  /// 于是切到流量时内核的自动更新真的会停掉，而不是等到下次改设置才生效。
  SmartOptionsStateProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'smartOptionsStateProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$smartOptionsStateHash();

  @$internal
  @override
  $ProviderElement<SmartOptions> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  SmartOptions create(Ref ref) {
    return smartOptionsState(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(SmartOptions value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<SmartOptions>(value),
    );
  }
}

String _$smartOptionsStateHash() => r'134a2e3012cc799f77e14cdbfac78f742bc8b9b6';
