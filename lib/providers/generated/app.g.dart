...
String _$viewModeHash() => r'49543696e0c0079a605fbce530c7bed5257208b1';
...
String _$networkDetectionHash() => r'09e10b317822cbfac755de0aad408f6c05b89242';
...
@ProviderFor(OnWifi)
final onWifiProvider = OnWifiProvider._();
...
/// 目前唯一的用途是「Smart 模型只在 Wi-Fi 下更新」那道闸，
/// 见 `SmartOptions.lgbmAutoUpdateNow`。
final class OnWifiProvider extends $NotifierProvider<OnWifi, bool> {
  /// 当前是不是连着 Wi-Fi。由 `manager/connectivity_manager.dart` 写入。
  ///
  /// **不要拿 [CurrentSSID] 是否为空来代替它**：读 SSID 需要定位权限，读不到时那边
  /// 会保留上一次的值，用它判断网络类型会拿到过期答案。连接类型本身不需要任何权限。
  ...
  @override
  String debugGetCreateSourceHash() => _$onWifiHash();

  @$internal
  @override
  OnWifi create() => OnWifi();
...
String _$onWifiHash() => r'8f866571d8816a6f38ffd6f9a6479f84e86ade9f';
...
abstract class _$OnWifi extends $Notifier<bool> {
  bool build();
  @$mustCallSuper
  @override
  WhenComplete runBuild() {
