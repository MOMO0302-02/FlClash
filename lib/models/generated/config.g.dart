...
_AppSettingProps _$AppSettingPropsFromJson(
  ...
  dashboardWidgetSpans:
      (json['dashboardWidgetSpans'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(k, (e as num).toInt()),
      ) ??
      const <String, int>{},
  dashboardWidgetRows:
      (json['dashboardWidgetRows'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(k, (e as num).toInt()),
      ) ??
      const <String, int>{},
  onlyStatisticsProxy: json['onlyStatisticsProxy'] as bool? ?? false,
  showNotificationSpeed: json['showNotificationSpeed'] as bool? ?? true,
  ...
  allowInsecureCertificate: json['allowInsecureCertificate'] as bool? ?? false,
  smartRouting: json['smartRouting'] as bool? ?? false,
  smartUseLightGBM: json['smartUseLightGBM'] as bool? ?? true,
  smartCollectData: json['smartCollectData'] as bool? ?? false,
  smartCollectorSize:
      (json['smartCollectorSize'] as num?)?.toInt() ??
      defaultSmartCollectorSize,
  smartStrategy:
      json['smartStrategy'] as String? ?? smartStrategyStickySessions,
  smartTolerance:
      (json['smartTolerance'] as num?)?.toInt() ?? defaultSmartTolerance,
  smartPreferAsn: json['smartPreferAsn'] as bool? ?? false,
  smartSampleRate: (json['smartSampleRate'] as num?)?.toDouble() ?? 1.0,
  smartLgbmAutoUpdate: json['smartLgbmAutoUpdate'] as bool? ?? true,
  smartLgbmUpdateInterval:
      (json['smartLgbmUpdateInterval'] as num?)?.toInt() ??
      defaultSmartLgbmInterval,
  smartLgbmUrl: json['smartLgbmUrl'] as String? ?? '',
  smartLgbmWifiOnly: json['smartLgbmWifiOnly'] as bool? ?? true,
);
...
Map<String, dynamic> _$AppSettingPropsToJson(_AppSettingProps instance) =>
    <String, dynamic>{
      ...
      'dashboardWidgets': instance.dashboardWidgets
          ...
          .toList(),
      'dashboardWidgetSpans': instance.dashboardWidgetSpans,
      'dashboardWidgetRows': instance.dashboardWidgetRows,
      'onlyStatisticsProxy': instance.onlyStatisticsProxy,
      'showNotificationSpeed': instance.showNotificationSpeed,
      ...
      'allowInsecureCertificate': instance.allowInsecureCertificate,
      'smartRouting': instance.smartRouting,
      'smartUseLightGBM': instance.smartUseLightGBM,
      'smartCollectData': instance.smartCollectData,
      'smartCollectorSize': instance.smartCollectorSize,
      'smartStrategy': instance.smartStrategy,
      'smartTolerance': instance.smartTolerance,
      'smartPreferAsn': instance.smartPreferAsn,
      'smartSampleRate': instance.smartSampleRate,
      'smartLgbmAutoUpdate': instance.smartLgbmAutoUpdate,
      'smartLgbmUpdateInterval': instance.smartLgbmUpdateInterval,
      'smartLgbmUrl': instance.smartLgbmUrl,
      'smartLgbmWifiOnly': instance.smartLgbmWifiOnly,
    };
...
const _$DashboardWidgetEnumMap = {
  DashboardWidget.statusHero: 'statusHero',
  ...
  DashboardWidget.smartRoutingButton: 'smartRoutingButton',
  DashboardWidget.intranetIp: 'intranetIp',
  DashboardWidget.proxyGroupTile: 'proxyGroupTile',
  DashboardWidget.profileTile: 'profileTile',
  DashboardWidget.connectionTile: 'connectionTile',
  DashboardWidget.requestTile: 'requestTile',
  DashboardWidget.logTile: 'logTile',
  DashboardWidget.resourceTile: 'resourceTile',
  DashboardWidget.settingTile: 'settingTile',
...
_ThemeProps _$ThemePropsFromJson(Map<String, dynamic> json) => _ThemeProps(
  ...
  appStyle: json['appStyle'] == null
      ? AppStyle.clashParty
      : AppStyle.safeFromJson(json['appStyle']),
...
Map<String, dynamic> _$ThemePropsToJson(_ThemeProps instance) =>
    <String, dynamic>{
      ...
      'appStyle': _$AppStyleEnumMap[instance.appStyle]!,
