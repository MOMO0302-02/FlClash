...
mixin _$IpInfo {
 ...
 String get ip; String get countryCode;/// 国家全名，如 `United States`。[countryCode] 是两位字母代码。
 String? get country; String? get region; String? get city; String? get timezone; double? get latitude; double? get longitude;/// 自治域号，不带 `AS` 前缀。
 int? get asn;/// 自治域的持有者，如 `Google LLC`。
 String? get asnOrganization; String? get isp;/// 使用这段地址的企业，通常比 [asnOrganization] 更具体：ASN 属于机房，
/// 企业才是租用者。
 String? get company;/// 地址用途：`hosting`（机房）/ `isp`（家宽）/ `business` / `education`
/// / `government`。机场节点几乎都是 `hosting`。
 String? get ipType;/// 第三方给出的滥用风险评分原文，如 `0.0012 (Low)`。**不是我们自己算的**，
/// 只能当参考。
 String? get risk;/// ASN 在注册局登记的国家，可能和 [countryCode] 不同：注册在美国的 ASN
/// 完全可以把机器放在日本。
 String? get registryCountry;/// 区域互联网注册管理机构，如 `ARIN` / `RIPE` / `APNIC`。
 String? get registry;/// 这个 IP 所属的路由前缀，如 `8.8.8.0/24`。
 String? get cidr; bool? get isProxy; bool? get isVpn; bool? get isTor;/// 是否属于机房地址段。为真基本可以确定这是台服务器而不是家宽。
 bool? get isDatacenter;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IpInfo&&(identical(other.ip, ip) || other.ip == ip)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.country, country) || other.country == country)&&(identical(other.region, region) || other.region == region)&&(identical(other.city, city) || other.city == city)&&(identical(other.timezone, timezone) || other.timezone == timezone)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.asn, asn) || other.asn == asn)&&(identical(other.asnOrganization, asnOrganization) || other.asnOrganization == asnOrganization)&&(identical(other.isp, isp) || other.isp == isp)&&(identical(other.company, company) || other.company == company)&&(identical(other.ipType, ipType) || other.ipType == ipType)&&(identical(other.risk, risk) || other.risk == risk)&&(identical(other.registryCountry, registryCountry) || other.registryCountry == registryCountry)&&(identical(other.registry, registry) || other.registry == registry)&&(identical(other.cidr, cidr) || other.cidr == cidr)&&(identical(other.isProxy, isProxy) || other.isProxy == isProxy)&&(identical(other.isVpn, isVpn) || other.isVpn == isVpn)&&(identical(other.isTor, isTor) || other.isTor == isTor)&&(identical(other.isDatacenter, isDatacenter) || other.isDatacenter == isDatacenter));
}


@override
int get hashCode => Object.hashAll([runtimeType,ip,countryCode,country,region,city,timezone,latitude,longitude,asn,asnOrganization,isp,company,ipType,risk,registryCountry,registry,cidr,isProxy,isVpn,isTor,isDatacenter]);

@override
String toString() {
  return 'IpInfo(ip: $ip, countryCode: $countryCode, country: $country, region: $region, city: $city, timezone: $timezone, latitude: $latitude, longitude: $longitude, asn: $asn, asnOrganization: $asnOrganization, isp: $isp, company: $company, ipType: $ipType, risk: $risk, registryCountry: $registryCountry, registry: $registry, cidr: $cidr, isProxy: $isProxy, isVpn: $isVpn, isTor: $isTor, isDatacenter: $isDatacenter)';
}
...
@useResult
$Res call({
 String ip, String countryCode, String? country, String? region, String? city, String? timezone, double? latitude, double? longitude, int? asn, String? asnOrganization, String? isp, String? company, String? ipType, String? risk, String? registryCountry, String? registry, String? cidr, bool? isProxy, bool? isVpn, bool? isTor, bool? isDatacenter
});
...
/// Create a copy of IpInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ip = null,Object? countryCode = null,Object? country = freezed,Object? region = freezed,Object? city = freezed,Object? timezone = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? asn = freezed,Object? asnOrganization = freezed,Object? isp = freezed,Object? company = freezed,Object? ipType = freezed,Object? risk = freezed,Object? registryCountry = freezed,Object? registry = freezed,Object? cidr = freezed,Object? isProxy = freezed,Object? isVpn = freezed,Object? isTor = freezed,Object? isDatacenter = freezed,}) {
  return _then(_self.copyWith(
...
as double?,asn: freezed == asn ? _self.asn : asn // ignore: cast_nullable_to_non_nullable
as int?,asnOrganization: freezed == asnOrganization ? _self.asnOrganization : asnOrganization // ignore: cast_nullable_to_non_nullable
as String?,isp: freezed == isp ? _self.isp : isp // ignore: cast_nullable_to_non_nullable
as String?,company: freezed == company ? _self.company : company // ignore: cast_nullable_to_non_nullable
as String?,ipType: freezed == ipType ? _self.ipType : ipType // ignore: cast_nullable_to_non_nullable
as String?,risk: freezed == risk ? _self.risk : risk // ignore: cast_nullable_to_non_nullable
as String?,registryCountry: freezed == registryCountry ? _self.registryCountry : registryCountry // ignore: cast_nullable_to_non_nullable
as String?,registry: freezed == registry ? _self.registry : registry // ignore: cast_nullable_to_non_nullable
as String?,cidr: freezed == cidr ? _self.cidr : cidr // ignore: cast_nullable_to_non_nullable
as String?,isProxy: freezed == isProxy ? _self.isProxy : isProxy // ignore: cast_nullable_to_non_nullable
as bool?,isVpn: freezed == isVpn ? _self.isVpn : isVpn // ignore: cast_nullable_to_non_nullable
as bool?,isTor: freezed == isTor ? _self.isTor : isTor // ignore: cast_nullable_to_non_nullable
as bool?,isDatacenter: freezed == isDatacenter ? _self.isDatacenter : isDatacenter // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ip,  String countryCode,  String? country,  String? region,  String? city,  String? timezone,  double? latitude,  double? longitude,  int? asn,  String? asnOrganization,  String? isp,  String? company,  String? ipType,  String? risk,  String? registryCountry,  String? registry,  String? cidr,  bool? isProxy,  bool? isVpn,  bool? isTor,  bool? isDatacenter)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IpInfo() when $default != null:
return $default(_that.ip,_that.countryCode,_that.country,_that.region,_that.city,_that.timezone,_that.latitude,_that.longitude,_that.asn,_that.asnOrganization,_that.isp,_that.company,_that.ipType,_that.risk,_that.registryCountry,_that.registry,_that.cidr,_that.isProxy,_that.isVpn,_that.isTor,_that.isDatacenter);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ip,  String countryCode,  String? country,  String? region,  String? city,  String? timezone,  double? latitude,  double? longitude,  int? asn,  String? asnOrganization,  String? isp,  String? company,  String? ipType,  String? risk,  String? registryCountry,  String? registry,  String? cidr,  bool? isProxy,  bool? isVpn,  bool? isTor,  bool? isDatacenter)  $default,) {final _that = this;
switch (_that) {
case _IpInfo():
return $default(_that.ip,_that.countryCode,_that.country,_that.region,_that.city,_that.timezone,_that.latitude,_that.longitude,_that.asn,_that.asnOrganization,_that.isp,_that.company,_that.ipType,_that.risk,_that.registryCountry,_that.registry,_that.cidr,_that.isProxy,_that.isVpn,_that.isTor,_that.isDatacenter);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ip,  String countryCode,  String? country,  String? region,  String? city,  String? timezone,  double? latitude,  double? longitude,  int? asn,  String? asnOrganization,  String? isp,  String? company,  String? ipType,  String? risk,  String? registryCountry,  String? registry,  String? cidr,  bool? isProxy,  bool? isVpn,  bool? isTor,  bool? isDatacenter)?  $default,) {final _that = this;
switch (_that) {
case _IpInfo() when $default != null:
return $default(_that.ip,_that.countryCode,_that.country,_that.region,_that.city,_that.timezone,_that.latitude,_that.longitude,_that.asn,_that.asnOrganization,_that.isp,_that.company,_that.ipType,_that.risk,_that.registryCountry,_that.registry,_that.cidr,_that.isProxy,_that.isVpn,_that.isTor,_that.isDatacenter);case _:
  return null;
...
class _IpInfo extends IpInfo {
  const _IpInfo({required this.ip, required this.countryCode, this.country, this.region, this.city, this.timezone, this.latitude, this.longitude, this.asn, this.asnOrganization, this.isp, this.company, this.ipType, this.risk, this.registryCountry, this.registry, this.cidr, this.isProxy, this.isVpn, this.isTor, this.isDatacenter}): super._();
...
@override final  String? asnOrganization;
...
/// 完全可以把机器放在日本。
@override final  String? registryCountry;
/// 区域互联网注册管理机构，如 `ARIN` / `RIPE` / `APNIC`。
@override final  String? registry;
/// 这个 IP 所属的路由前缀，如 `8.8.8.0/24`。
@override final  String? cidr;
@override final  bool? isProxy;
@override final  bool? isVpn;
@override final  bool? isTor;
/// 是否属于机房地址段。为真基本可以确定这是台服务器而不是家宽。
@override final  bool? isDatacenter;
...
/// Create a copy of IpInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ip = null,Object? countryCode = null,Object? country = freezed,Object? region = freezed,Object? city = freezed,Object? timezone = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? asn = freezed,Object? asnOrganization = freezed,Object? isp = freezed,Object? company = freezed,Object? ipType = freezed,Object? risk = freezed,Object? registryCountry = freezed,Object? registry = freezed,Object? cidr = freezed,Object? isProxy = freezed,Object? isVpn = freezed,Object? isTor = freezed,Object? isDatacenter = freezed,}) {
