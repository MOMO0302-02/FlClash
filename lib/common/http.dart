...
class ClashPartyHttpOverrides extends HttpOverrides {
  static String handleFindProxy(Uri url) {
    ...
    // 这里是每一次 dart:io 请求的必经之路，订阅更新也走这条。整条 URL 就是
    // 凭据（token 可能在查询串，也可能在路径里），只记到 host 为止。
    commonPrint.log('find ${redactUri(url)} proxy: $isStart');
