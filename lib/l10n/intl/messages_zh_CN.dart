...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(label) => "「${label}」连续自动更新失败，订阅地址可能已失效，去配置页手动同步或换一个";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "helperCorruptTip": MessageLookupByLibrary.simpleMessage(
      "Helper 服务不可用，无法启用 TUN 模式，请重新安装 Clash MO。",
    ),
    ...
    "infoMode": MessageLookupByLibrary.simpleMessage("信息模式"),
    "detailedInfo": MessageLookupByLibrary.simpleMessage("详细信息"),
    "conciseInfo": MessageLookupByLibrary.simpleMessage("简洁信息"),
    ...
    "company": MessageLookupByLibrary.simpleMessage("企业"),
    ...
    "riskTip": MessageLookupByLibrary.simpleMessage(
      "风险评分来自第三方数据源，反映的是这段地址被举报滥用的历史，不代表当前连接的安全性，仅供参考。",
    ),
    "registryCountry": MessageLookupByLibrary.simpleMessage("注册国家"),
    "registry": MessageLookupByLibrary.simpleMessage("注册局"),
    "connectivityTest": MessageLookupByLibrary.simpleMessage("连通性检测"),
    "ipv6Support": MessageLookupByLibrary.simpleMessage("IPv6 支持"),
    "supported": MessageLookupByLibrary.simpleMessage("支持"),
    "notSupported": MessageLookupByLibrary.simpleMessage("不支持"),
    "unreachable": MessageLookupByLibrary.simpleMessage("不可达"),
    "timeZone": MessageLookupByLibrary.simpleMessage("时区"),
    "total": MessageLookupByLibrary.simpleMessage("合计"),
    "duration": MessageLookupByLibrary.simpleMessage("已连接时长"),
    "averageSpeed": MessageLookupByLibrary.simpleMessage("平均速率"),
    "peakSpeed": MessageLookupByLibrary.simpleMessage("峰值速率"),
    "releaseMemory": MessageLookupByLibrary.simpleMessage("释放内存"),
    "releaseMemoryDesc": MessageLookupByLibrary.simpleMessage("让内核立即回收一次内存"),
    "networkInterfaces": MessageLookupByLibrary.simpleMessage("网络接口"),
    "trafficRankTip": MessageLookupByLibrary.simpleMessage(
      "排行只统计当前仍然活着的连接，已经关闭的连接不计入。",
    ),
    "smartRouting": MessageLookupByLibrary.simpleMessage("自动 Smart 覆写"),
    "smartRoutingDesc": MessageLookupByLibrary.simpleMessage(
      "按节点以往的表现自动挑，不用自己选",
    ),
    "smartRoutingOn": MessageLookupByLibrary.simpleMessage("自动挑选"),
    "smartRoutingOff": MessageLookupByLibrary.simpleMessage("按延迟挑选"),
    "vpnStateOn": MessageLookupByLibrary.simpleMessage("接管全部流量"),
    "vpnStateOff": MessageLookupByLibrary.simpleMessage("仅本地端口"),
    "tileStateOff": MessageLookupByLibrary.simpleMessage("已关闭"),
    "tileStateOn": MessageLookupByLibrary.simpleMessage("已开启"),
    "smartCore": MessageLookupByLibrary.simpleMessage("Smart 内核"),
    "smartRoutingDetail": MessageLookupByLibrary.simpleMessage(
      "把订阅里的分组换成 Smart 组，由内核按历史表现挑节点",
    ),
    "smartUseLightGBM": MessageLookupByLibrary.simpleMessage("使用 LightGBM"),
    "smartUseLightGBMDesc": MessageLookupByLibrary.simpleMessage(
      "用预训练的模型挑节点，通常更准，但未必适合你的网络",
    ),
    "smartCollectData": MessageLookupByLibrary.simpleMessage("收集数据"),
    "smartCollectDataDesc": MessageLookupByLibrary.simpleMessage(
      "记录你的使用情况，用来训练专属模型。不打算训练就关着",
    ),
    "smartCollectorSize": MessageLookupByLibrary.simpleMessage("数据收集文件大小"),
    "smartCollectorSizeDesc": MessageLookupByLibrary.simpleMessage("记录文件最多占多大"),
    "smartStrategy": MessageLookupByLibrary.simpleMessage("策略模式"),
    "smartStrategyDesc": MessageLookupByLibrary.simpleMessage(
      "粘性会话＝同一个网站尽量固定用同一个节点；轮询＝在候选节点之间轮着用",
    ),
    "smartStrategyStickySessions": MessageLookupByLibrary.simpleMessage("粘性会话"),
    "smartStrategyRoundRobin": MessageLookupByLibrary.simpleMessage("轮询"),
    "smartTolerance": MessageLookupByLibrary.simpleMessage("延迟容差"),
    "smartToleranceDesc": MessageLookupByLibrary.simpleMessage(
      "延迟差在这个数以内就算一样快，避免来回横跳。0 = 关",
    ),
    "smartPreferAsn": MessageLookupByLibrary.simpleMessage("按运营商归纳"),
    "smartPreferAsnDesc": MessageLookupByLibrary.simpleMessage(
      "多查一次目标属于哪家运营商，让 Smart 学得更准；代价是慢一点",
    ),
    "smartSampleRate": MessageLookupByLibrary.simpleMessage("数据采样率"),
    "smartSampleRateDesc": MessageLookupByLibrary.simpleMessage(
      "只记其中一部分，让文件涨得慢些。1 表示全记；不影响选节点",
    ),
    ...
    "snifferForceDnsMappingDesc": MessageLookupByLibrary.simpleMessage(
      "对已经通过 DNS 认出域名的流量再认一次，更准",
    ),
    "snifferParsePureIp": MessageLookupByLibrary.simpleMessage("嗅探完全没有域名的流量"),
    "snifferParsePureIpDesc": MessageLookupByLibrary.simpleMessage(
      "直接连 IP、完全没有域名的连接也认一次",
    ),
    "snifferProtocols": MessageLookupByLibrary.simpleMessage("嗅探哪些协议"),
    "snifferPorts": MessageLookupByLibrary.simpleMessage("端口"),
    "snifferPortsDesc": MessageLookupByLibrary.simpleMessage("列表留空就是用内核的默认端口"),
    "snifferPortsDefault": MessageLookupByLibrary.simpleMessage("内核默认端口"),
    "snifferQuicDesc": MessageLookupByLibrary.simpleMessage(
      "安卓上 Chrome 等应用默认走 QUIC。不认它就拿不到域名，规则会匹配不上",
    ),
    "snifferSkipDomain": MessageLookupByLibrary.simpleMessage("丢弃这些嗅探结果"),
    "snifferSkipDomainDesc": MessageLookupByLibrary.simpleMessage(
      "认出的域名是这些时，就当作没认出来",
    ),
    "snifferForceDomain": MessageLookupByLibrary.simpleMessage("一律嗅探这些域名"),
    "snifferForceDomainDesc": MessageLookupByLibrary.simpleMessage(
      "这些域名一律要认，别的设置不能跳过",
    ),
    "snifferSkipSrcAddress": MessageLookupByLibrary.simpleMessage("跳过这些来源地址"),
    "snifferSkipSrcAddressDesc": MessageLookupByLibrary.simpleMessage(
      "来自这些网段的流量不认",
    ),
    "snifferSkipDstAddress": MessageLookupByLibrary.simpleMessage("跳过这些目标地址"),
    "snifferSkipDstAddressDesc": MessageLookupByLibrary.simpleMessage(
      "发往这些网段的流量不认",
    ),
    "lanAuth": MessageLookupByLibrary.simpleMessage("局域网访问密码"),
    "lanAuthDesc": MessageLookupByLibrary.simpleMessage("别人要用你的代理端口，先输用户名和密码"),
    "lanAuthWarning": MessageLookupByLibrary.simpleMessage(
      "已允许局域网访问但没设密码：同一个 Wi-Fi 下谁都能用你的代理",
    ),
    "lanAuthEmpty": MessageLookupByLibrary.simpleMessage("还没有添加账号"),
    "lanAuthLocalTip": MessageLookupByLibrary.simpleMessage(
      "本机自己不用输密码，系统代理不受影响",
    ),
    "userName": MessageLookupByLibrary.simpleMessage("用户名"),
    "skipAuthPrefixes": MessageLookupByLibrary.simpleMessage("免密码的地址"),
    "skipAuthPrefixesDesc": MessageLookupByLibrary.simpleMessage(
      "这些网段不用输密码。删掉本机地址会让系统代理断网",
    ),
    "externalControllerSecret": MessageLookupByLibrary.simpleMessage("控制器密钥"),
    "externalControllerSecretDesc": MessageLookupByLibrary.simpleMessage(
      "调用控制器接口要用。本机上别的应用也连得到，建议设一个",
    ),
    "generateRandom": MessageLookupByLibrary.simpleMessage("随机生成"),
    "notificationSpeed": MessageLookupByLibrary.simpleMessage("通知栏显示速率"),
    "notificationSpeedDesc": MessageLookupByLibrary.simpleMessage(
      "通知本身不会消失，只是那行速率不再显示",
    ),
    "snifferFilters": MessageLookupByLibrary.simpleMessage("例外"),
    "lanAuthUserNameTip": MessageLookupByLibrary.simpleMessage("用户名里不能有冒号"),
    "smartRoutingGlobalTip": MessageLookupByLibrary.simpleMessage(
      "全局模式下请选择节点「Smart Group」",
    ),
    "smartModel": MessageLookupByLibrary.simpleMessage("选路模型"),
    "smartModelReady": MessageLookupByLibrary.simpleMessage("已就绪"),
    "smartModelMissing": MessageLookupByLibrary.simpleMessage("还没下载，现在仍按延迟挑节点"),
    "smartModelDamaged": MessageLookupByLibrary.simpleMessage("文件不完整，请重新下载"),
    "smartModelNotReady": MessageLookupByLibrary.simpleMessage("模型未就绪"),
    "smartModelDownloading": MessageLookupByLibrary.simpleMessage("正在下载…"),
    "smartModelDownloaded": MessageLookupByLibrary.simpleMessage("模型已就绪"),
    "smartModelInvalid": MessageLookupByLibrary.simpleMessage(
      "下载到的不是可用的模型，已保留原来的",
    ),
    "smartLgbmAutoUpdate": MessageLookupByLibrary.simpleMessage("自动更新模型"),
    "smartLgbmAutoUpdateDesc": MessageLookupByLibrary.simpleMessage(
      "让内核自己定期去取新模型",
    ),
    "smartLgbmWifiOnly": MessageLookupByLibrary.simpleMessage("仅在 Wi-Fi 下更新"),
    "smartLgbmWifiOnlyDesc": MessageLookupByLibrary.simpleMessage(
      "模型有几十兆，开着就不会用流量去下",
    ),
    "smartLgbmUpdateInterval": MessageLookupByLibrary.simpleMessage("更新间隔"),
    "smartLgbmUpdateIntervalDesc": MessageLookupByLibrary.simpleMessage(
      "隔多久去看一次有没有新模型",
    ),
    "smartLgbmUrl": MessageLookupByLibrary.simpleMessage("模型下载地址"),
    "smartLgbmUrlDesc": MessageLookupByLibrary.simpleMessage(
      "留空用内置地址。换成大一点的模型更准，也更占空间",
    ),
    "profileUpdateTimeoutTip": MessageLookupByLibrary.simpleMessage(
      "更新订阅超时，检查一下订阅地址是不是还有效",
    ),
    "streamNeedRunningDesc": MessageLookupByLibrary.simpleMessage(
      "代理还没启动，启动之后这里才会有数据",
    ),
    "profileAutoUpdateFailedTip": m26,
    "backupEncryptTitle": MessageLookupByLibrary.simpleMessage("加密备份"),
    "backupEncryptDesc": MessageLookupByLibrary.simpleMessage(
      "备份里含订阅链接和 WebDAV 账号密码。请设置一个密码来加密，恢复时需要输入同一个密码。密码遗忘将无法恢复此备份。",
    ),
    "restoreDecryptTitle": MessageLookupByLibrary.simpleMessage("输入备份密码"),
    "restoreDecryptDesc": MessageLookupByLibrary.simpleMessage(
      "该备份已加密，请输入创建时设置的密码。",
    ),
    "restoreDecryptError": MessageLookupByLibrary.simpleMessage("密码错误或备份文件已损坏"),
    "insecureWebDAVWarning": MessageLookupByLibrary.simpleMessage(
      "该地址使用明文 HTTP，账号密码会以未加密方式在网络上传输。除非是可信的局域网，否则建议改用 HTTPS。",
    ),
    "smartModelSize": MessageLookupByLibrary.simpleMessage("模型大小"),
    "smartModelSizeDesc": MessageLookupByLibrary.simpleMessage(
      "模型越大选路越准，下载和内存占用也越多",
    ),
    "smartModelSizeStandard": MessageLookupByLibrary.simpleMessage("标准"),
    "smartModelSizeMiddle": MessageLookupByLibrary.simpleMessage("中等"),
    "smartModelSizeLarge": MessageLookupByLibrary.simpleMessage("大号"),
    "smartModelSizeCustom": MessageLookupByLibrary.simpleMessage("自定义地址"),
    "geoResourceNotDownloaded": MessageLookupByLibrary.simpleMessage("未下载"),
  };
}
