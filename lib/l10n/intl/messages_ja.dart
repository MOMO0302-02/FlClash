...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(label) =>
      "「${label}」の自動更新が連続で失敗しています。購読アドレスが無効かもしれません。手動更新するかアドレスを変更してください";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "infoMode": MessageLookupByLibrary.simpleMessage("表示モード"),
    "detailedInfo": MessageLookupByLibrary.simpleMessage("詳細情報"),
    "conciseInfo": MessageLookupByLibrary.simpleMessage("簡易情報"),
    ...
    "overrideDnsOffTip": MessageLookupByLibrary.simpleMessage(
      "オフの場合、下の設定はサブスクリプション自体に DNS 設定がないときのみ有効です。",
    ),
    ...
    "location": MessageLookupByLibrary.simpleMessage("所在地"),
    "longitude": MessageLookupByLibrary.simpleMessage("経度"),
    "latitude": MessageLookupByLibrary.simpleMessage("緯度"),
    "asnOwner": MessageLookupByLibrary.simpleMessage("ASN 所有者"),
    "company": MessageLookupByLibrary.simpleMessage("企業"),
    ...
    "riskTip": MessageLookupByLibrary.simpleMessage(
      "リスクスコアはサードパーティのデータソースによるものです。このアドレス帯に報告された不正利用の履歴を示すもので、現在の接続の安全性を表すものではありません。参考程度にご利用ください。",
    ),
    "registryCountry": MessageLookupByLibrary.simpleMessage("登録国"),
    "registry": MessageLookupByLibrary.simpleMessage("登録機関"),
    "connectivityTest": MessageLookupByLibrary.simpleMessage("接続性テスト"),
    "ipv6Support": MessageLookupByLibrary.simpleMessage("IPv6 対応"),
    "supported": MessageLookupByLibrary.simpleMessage("対応"),
    "notSupported": MessageLookupByLibrary.simpleMessage("非対応"),
    "unreachable": MessageLookupByLibrary.simpleMessage("到達不可"),
    "timeZone": MessageLookupByLibrary.simpleMessage("タイムゾーン"),
    "total": MessageLookupByLibrary.simpleMessage("合計"),
    "duration": MessageLookupByLibrary.simpleMessage("接続時間"),
    "averageSpeed": MessageLookupByLibrary.simpleMessage("平均速度"),
    "peakSpeed": MessageLookupByLibrary.simpleMessage("ピーク速度"),
    "releaseMemory": MessageLookupByLibrary.simpleMessage("メモリを解放"),
    "releaseMemoryDesc": MessageLookupByLibrary.simpleMessage(
      "コアにメモリの回収を要求します",
    ),
    "networkInterfaces": MessageLookupByLibrary.simpleMessage("ネットワークインターフェース"),
    "trafficRankTip": MessageLookupByLibrary.simpleMessage(
      "ランキングは現在有効な接続のみを集計します。終了した接続は含まれません。",
    ),
    "smartRouting": MessageLookupByLibrary.simpleMessage("自動 Smart 上書き"),
    "smartRoutingDesc": MessageLookupByLibrary.simpleMessage(
      "これまでの実績からノードを自動で選びます",
    ),
    "smartRoutingOn": MessageLookupByLibrary.simpleMessage("自動選択"),
    "smartRoutingOff": MessageLookupByLibrary.simpleMessage("遅延で選択"),
    "vpnStateOn": MessageLookupByLibrary.simpleMessage("全トラフィック"),
    "vpnStateOff": MessageLookupByLibrary.simpleMessage("ローカルポートのみ"),
    "tileStateOff": MessageLookupByLibrary.simpleMessage("オフ"),
    "tileStateOn": MessageLookupByLibrary.simpleMessage("オン"),
    "smartCore": MessageLookupByLibrary.simpleMessage("スマートコア"),
    "smartRoutingDetail": MessageLookupByLibrary.simpleMessage(
      "サブスクリプション内のグループを Smart グループに変換し、コアが実績に基づいてノードを選びます",
    ),
    "smartUseLightGBM": MessageLookupByLibrary.simpleMessage("LightGBM を使用"),
    "smartUseLightGBMDesc": MessageLookupByLibrary.simpleMessage(
      "学習済みモデルでノードを選びます。多くの場合は高精度ですが、環境次第です",
    ),
    "smartCollectData": MessageLookupByLibrary.simpleMessage("データを収集"),
    "smartCollectDataDesc": MessageLookupByLibrary.simpleMessage(
      "利用状況を記録し、専用モデルの学習に使います。学習しないならオフのままで",
    ),
    "smartCollectorSize": MessageLookupByLibrary.simpleMessage("データ収集ファイルのサイズ"),
    "smartCollectorSizeDesc": MessageLookupByLibrary.simpleMessage(
      "記録ファイルの上限サイズ",
    ),
    "smartStrategy": MessageLookupByLibrary.simpleMessage("ストラテジーモード"),
    "smartStrategyDesc": MessageLookupByLibrary.simpleMessage(
      "スティッキーは同じサイトを同じノードに固定、ラウンドロビンは候補を順番に使います",
    ),
    "smartStrategyStickySessions": MessageLookupByLibrary.simpleMessage(
      "スティッキーセッション",
    ),
    "smartStrategyRoundRobin": MessageLookupByLibrary.simpleMessage("ラウンドロビン"),
    "smartTolerance": MessageLookupByLibrary.simpleMessage("遅延の許容差"),
    "smartToleranceDesc": MessageLookupByLibrary.simpleMessage(
      "この差（ミリ秒）以内は同じ速さとみなし、切り替えの往復を防ぎます。0 でオフ",
    ),
    "smartPreferAsn": MessageLookupByLibrary.simpleMessage("ASN を優先"),
    "smartPreferAsnDesc": MessageLookupByLibrary.simpleMessage(
      "宛先の通信事業者を一度多く調べ、学習精度を上げます。その分わずかに遅くなります",
    ),
    "smartSampleRate": MessageLookupByLibrary.simpleMessage("データのサンプリング率"),
    "smartSampleRateDesc": MessageLookupByLibrary.simpleMessage(
      "一部だけ記録してファイルの増加を抑えます。1 は全件。ノード選択には影響しません",
    ),
    "smartSampleRateTip": MessageLookupByLibrary.simpleMessage(
      "0 より大きく 1 以下の数値を入力してください",
    ),
    "milliseconds": MessageLookupByLibrary.simpleMessage("ミリ秒"),
    "scanUnrecognizedTip": MessageLookupByLibrary.simpleMessage(
      "このコードは利用できるサブスクリプションリンクではありません。別のものをスキャンしてください。",
    ),
    "alwaysOnVpn": MessageLookupByLibrary.simpleMessage("常時接続 VPN"),
    "alwaysOnVpnDesc": MessageLookupByLibrary.simpleMessage(
      "再起動や異常終了のあとも、システムが VPN を自動的に復帰させます。",
    ),
    "alwaysOnVpnGuide": MessageLookupByLibrary.simpleMessage(
      "この設定はシステム設定内にあります：設定 > ネットワークとインターネット > VPN > Clash MO > 常時接続 VPN。メーカーによって場所が異なります。",
    ),
    "sniffer": MessageLookupByLibrary.simpleMessage("ドメインスニッフィング"),
    "snifferDesc": MessageLookupByLibrary.simpleMessage(
      "通信からドメイン名を読み取り、ルールを一致させます",
    ),
    "snifferOverrideDest": MessageLookupByLibrary.simpleMessage(
      "スニッフィング結果を実際の接続先として使う",
    ),
    "snifferOverrideDestDesc": MessageLookupByLibrary.simpleMessage(
      "オフのときはルール照合にのみ使い、接続先は元のままです",
    ),
    "snifferForceDnsMapping": MessageLookupByLibrary.simpleMessage(
      "DNS マッピングで復元されたトラフィックを再度スニッフィング",
    ),
    "snifferForceDnsMappingDesc": MessageLookupByLibrary.simpleMessage(
      "DNS 由来のドメインを持つ通信も再確認します。精度が上がります",
    ),
    "snifferParsePureIp": MessageLookupByLibrary.simpleMessage(
      "ドメインを持たないトラフィックもスニッフィング",
    ),
    "snifferParsePureIpDesc": MessageLookupByLibrary.simpleMessage(
      "ドメインのない IP 直接接続も確認します",
    ),
    "snifferProtocols": MessageLookupByLibrary.simpleMessage("スニッフィングするプロトコル"),
    "snifferPorts": MessageLookupByLibrary.simpleMessage("ポート"),
    "snifferPortsDesc": MessageLookupByLibrary.simpleMessage(
      "リストを空にするとカーネルの既定ポートを使います",
    ),
    "snifferPortsDefault": MessageLookupByLibrary.simpleMessage("カーネルの既定ポート"),
    "snifferQuicDesc": MessageLookupByLibrary.simpleMessage(
      "Android では Chrome などが既定で QUIC を使います。無効だとドメインが分からずルールが外れます",
    ),
    "snifferSkipDomain": MessageLookupByLibrary.simpleMessage(
      "これらのスニッフィング結果を破棄",
    ),
    "snifferSkipDomainDesc": MessageLookupByLibrary.simpleMessage(
      "検出結果がこれらに一致した場合は無視します",
    ),
    ...
    "lanAuth": MessageLookupByLibrary.simpleMessage("LAN アクセスのパスワード"),
    "lanAuthDesc": MessageLookupByLibrary.simpleMessage(
      "プロキシポートの利用にユーザー名とパスワードを要求します",
    ),
    "lanAuthWarning": MessageLookupByLibrary.simpleMessage(
      "LAN アクセスが有効でパスワード未設定です。同じ Wi-Fi の誰でも利用できます",
    ),
    "lanAuthEmpty": MessageLookupByLibrary.simpleMessage("アカウントが未登録です"),
    "lanAuthLocalTip": MessageLookupByLibrary.simpleMessage(
      "この端末はパスワード不要なので、システムプロキシは影響を受けません",
    ),
    "userName": MessageLookupByLibrary.simpleMessage("ユーザー名"),
    "skipAuthPrefixes": MessageLookupByLibrary.simpleMessage("パスワードを免除するアドレス"),
    "skipAuthPrefixesDesc": MessageLookupByLibrary.simpleMessage(
      "これらの範囲はパスワード不要です。端末自身のアドレスを消すとシステムプロキシが切れます",
    ),
    ...
    "externalControllerSecretDesc": MessageLookupByLibrary.simpleMessage(
      "コントローラー API の呼び出しに必要。同じ端末の他アプリからも到達できます",
    ),
    "generateRandom": MessageLookupByLibrary.simpleMessage("ランダム生成"),
    "notificationSpeed": MessageLookupByLibrary.simpleMessage("通知に速度を表示"),
    "notificationSpeedDesc": MessageLookupByLibrary.simpleMessage(
      "通知そのものは残り、速度の行だけが非表示になります",
    ),
    "snifferFilters": MessageLookupByLibrary.simpleMessage("例外"),
    "lanAuthUserNameTip": MessageLookupByLibrary.simpleMessage(
      "ユーザー名にコロンは使えません",
    ),
    "smartRoutingGlobalTip": MessageLookupByLibrary.simpleMessage(
      "グローバルモードでは「Smart Group」ノードを選択してください",
    ),
    "smartModel": MessageLookupByLibrary.simpleMessage("ルーティングモデル"),
    "smartModelReady": MessageLookupByLibrary.simpleMessage("利用可能"),
    "smartModelMissing": MessageLookupByLibrary.simpleMessage(
      "未ダウンロードのため、現在は遅延でノードを選んでいます",
    ),
    "smartModelDamaged": MessageLookupByLibrary.simpleMessage(
      "ファイルが不完全です。再ダウンロードしてください",
    ),
    "smartModelNotReady": MessageLookupByLibrary.simpleMessage("モデル未準備"),
    "smartModelDownloading": MessageLookupByLibrary.simpleMessage("ダウンロード中…"),
    "smartModelDownloaded": MessageLookupByLibrary.simpleMessage(
      "モデルの準備ができました",
    ),
    "smartModelInvalid": MessageLookupByLibrary.simpleMessage(
      "取得したファイルは有効なモデルではありません。元のまま維持しました",
    ),
    "smartLgbmAutoUpdate": MessageLookupByLibrary.simpleMessage("モデルを自動更新"),
    "smartLgbmAutoUpdateDesc": MessageLookupByLibrary.simpleMessage(
      "コアが定期的に新しいモデルを取得します",
    ),
    "smartLgbmWifiOnly": MessageLookupByLibrary.simpleMessage("Wi-Fi のときだけ更新"),
    "smartLgbmWifiOnlyDesc": MessageLookupByLibrary.simpleMessage(
      "モデルは数十 MB です。モバイル通信では取得しません",
    ),
    "smartLgbmUpdateInterval": MessageLookupByLibrary.simpleMessage("更新間隔"),
    "smartLgbmUpdateIntervalDesc": MessageLookupByLibrary.simpleMessage(
      "新しいモデルを確認する間隔",
    ),
    "smartLgbmUrl": MessageLookupByLibrary.simpleMessage("モデルの取得先"),
    "smartLgbmUrlDesc": MessageLookupByLibrary.simpleMessage(
      "空欄なら内蔵の取得先を使います。大きいモデルほど高精度ですが容量も増えます",
    ),
    "profileUpdateTimeoutTip": MessageLookupByLibrary.simpleMessage(
      "サブスクリプションの更新がタイムアウトしました。アドレスが有効か確認してください",
    ),
    "streamNeedRunningDesc": MessageLookupByLibrary.simpleMessage(
      "プロキシが未起動です。起動するとここにデータが表示されます",
    ),
    "profileAutoUpdateFailedTip": m26,
    "backupEncryptTitle": MessageLookupByLibrary.simpleMessage("バックアップを暗号化"),
    "backupEncryptDesc": MessageLookupByLibrary.simpleMessage(
      "バックアップにはサブスクリプションのリンクと WebDAV の認証情報が含まれます。暗号化のためパスワードを設定してください。復元時に同じパスワードが必要です。忘れると復元できません。",
    ),
    "restoreDecryptTitle": MessageLookupByLibrary.simpleMessage(
      "バックアップのパスワードを入力",
    ),
    "restoreDecryptDesc": MessageLookupByLibrary.simpleMessage(
      "このバックアップは暗号化されています。作成時に設定したパスワードを入力してください。",
    ),
    "restoreDecryptError": MessageLookupByLibrary.simpleMessage(
      "パスワードが違うか、バックアップファイルが破損しています",
    ),
    "insecureWebDAVWarning": MessageLookupByLibrary.simpleMessage(
      "このアドレスは平文の HTTP を使用しており、ユーザー名とパスワードが暗号化されずに送信されます。信頼できるローカルネットワークでない限り HTTPS の使用を推奨します。",
    ),
    "smartModelSize": MessageLookupByLibrary.simpleMessage("モデルサイズ"),
    "smartModelSizeDesc": MessageLookupByLibrary.simpleMessage(
      "モデルが大きいほど選択精度は上がりますが、通信量とメモリも増えます",
    ),
    "smartModelSizeStandard": MessageLookupByLibrary.simpleMessage("標準"),
    "smartModelSizeMiddle": MessageLookupByLibrary.simpleMessage("中"),
    "smartModelSizeLarge": MessageLookupByLibrary.simpleMessage("大"),
    "smartModelSizeCustom": MessageLookupByLibrary.simpleMessage("カスタム URL"),
    "geoResourceNotDownloaded": MessageLookupByLibrary.simpleMessage("未ダウンロード"),
  };
}
