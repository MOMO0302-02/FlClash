...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(label) =>
      "«${label}» не удаётся обновить автоматически — возможно, адрес подписки больше не работает; обновите вручную или замените";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accessControlNotEnabledDesc": MessageLookupByLibrary.simpleMessage(
      "Пока выключено. Изменения вступят в силу после включения.",
    ),
    ...
    "helperCorruptTip": MessageLookupByLibrary.simpleMessage(
      "Служба Helper недоступна, поэтому TUN-режим включить нельзя. Переустановите Clash MO.",
    ),
    ...
    "infoMode": MessageLookupByLibrary.simpleMessage("Режим сведений"),
    "detailedInfo": MessageLookupByLibrary.simpleMessage("Подробно"),
    "conciseInfo": MessageLookupByLibrary.simpleMessage("Кратко"),
    ...
    "overrideDnsOffTip": MessageLookupByLibrary.simpleMessage(
      "Когда выключено, настройки ниже действуют только если в подписке нет своей секции DNS.",
    ),
    ...
    "asnOwner": MessageLookupByLibrary.simpleMessage("Владелец ASN"),
    "company": MessageLookupByLibrary.simpleMessage("Компания"),
    "ipType": MessageLookupByLibrary.simpleMessage("Тип IP"),
    "risk": MessageLookupByLibrary.simpleMessage("Риск"),
    "riskTip": MessageLookupByLibrary.simpleMessage(
      "Оценка риска получена из стороннего источника данных. Она отражает жалобы на злоупотребления для этого диапазона адресов, а не безопасность текущего подключения, и приводится только для справки.",
    ),
    "registryCountry": MessageLookupByLibrary.simpleMessage(
      "Страна регистрации",
    ),
    "registry": MessageLookupByLibrary.simpleMessage("Регистратура"),
    "connectivityTest": MessageLookupByLibrary.simpleMessage("Проверка связи"),
    "ipv6Support": MessageLookupByLibrary.simpleMessage("Поддержка IPv6"),
    ...
    "unreachable": MessageLookupByLibrary.simpleMessage("Недоступно"),
    ...
    "averageSpeed": MessageLookupByLibrary.simpleMessage("Средняя скорость"),
    "peakSpeed": MessageLookupByLibrary.simpleMessage("Пиковая скорость"),
    "releaseMemory": MessageLookupByLibrary.simpleMessage("Освободить память"),
    "releaseMemoryDesc": MessageLookupByLibrary.simpleMessage(
      "Запросить у ядра немедленную очистку памяти",
    ),
    "networkInterfaces": MessageLookupByLibrary.simpleMessage(
      "Сетевые интерфейсы",
    ),
    "trafficRankTip": MessageLookupByLibrary.simpleMessage(
      "В рейтинг попадают только активные соединения; закрытые не учитываются.",
    ),
    "smartRouting": MessageLookupByLibrary.simpleMessage(
      "Автоматическое Smart-переопределение",
    ),
    "smartRoutingDesc": MessageLookupByLibrary.simpleMessage(
      "Выбирает узлы автоматически по их прошлым результатам",
    ),
    "smartRoutingOn": MessageLookupByLibrary.simpleMessage("Авто-выбор"),
    "smartRoutingOff": MessageLookupByLibrary.simpleMessage("По задержке"),
    "vpnStateOn": MessageLookupByLibrary.simpleMessage("Весь трафик"),
    "vpnStateOff": MessageLookupByLibrary.simpleMessage(
      "Только локальный порт",
    ),
    "tileStateOff": MessageLookupByLibrary.simpleMessage("Выключено"),
    "tileStateOn": MessageLookupByLibrary.simpleMessage("Включено"),
    "smartCore": MessageLookupByLibrary.simpleMessage("Ядро Smart"),
    "smartRoutingDetail": MessageLookupByLibrary.simpleMessage(
      "Превращает группы из подписки в Smart-группы, чтобы ядро выбирало узлы по прошлым результатам",
    ),
    "smartUseLightGBM": MessageLookupByLibrary.simpleMessage(
      "Использовать LightGBM",
    ),
    "smartUseLightGBMDesc": MessageLookupByLibrary.simpleMessage(
      "Выбор узлов по готовой модели. Обычно точнее, но подходит не всякой сети",
    ),
    "smartCollectData": MessageLookupByLibrary.simpleMessage("Собирать данные"),
    "smartCollectDataDesc": MessageLookupByLibrary.simpleMessage(
      "Записывает вашу активность для обучения своей модели. Не обучаете — оставьте выключенным",
    ),
    "smartCollectorSize": MessageLookupByLibrary.simpleMessage(
      "Размер файла сбора данных",
    ),
    "smartCollectorSizeDesc": MessageLookupByLibrary.simpleMessage(
      "Максимальный размер файла записей",
    ),
    "smartStrategy": MessageLookupByLibrary.simpleMessage("Режим стратегии"),
    "smartStrategyDesc": MessageLookupByLibrary.simpleMessage(
      "Липкие сессии держат сайт на одном узле; круговой режим чередует кандидатов",
    ),
    "smartStrategyStickySessions": MessageLookupByLibrary.simpleMessage(
      "Липкие сессии",
    ),
    "smartStrategyRoundRobin": MessageLookupByLibrary.simpleMessage(
      "Круговой перебор",
    ),
    "smartTolerance": MessageLookupByLibrary.simpleMessage("Допуск задержки"),
    "smartToleranceDesc": MessageLookupByLibrary.simpleMessage(
      "Разница в пределах этого числа мс считается равной — узлы перестают скакать. 0 — выкл",
    ),
    "smartPreferAsn": MessageLookupByLibrary.simpleMessage("Учитывать ASN"),
    "smartPreferAsnDesc": MessageLookupByLibrary.simpleMessage(
      "Дополнительный запрос оператора назначения — Smart учится точнее, но чуть медленнее",
    ),
    "smartSampleRate": MessageLookupByLibrary.simpleMessage(
      "Частота выборки данных",
    ),
    "smartSampleRateDesc": MessageLookupByLibrary.simpleMessage(
      "Записывает лишь часть данных, чтобы файл рос медленнее. 1 — всё; на выбор узла не влияет",
    ),
    "smartSampleRateTip": MessageLookupByLibrary.simpleMessage(
      "Введите число больше 0 и не больше 1",
    ),
    "milliseconds": MessageLookupByLibrary.simpleMessage("мс"),
    "scanUnrecognizedTip": MessageLookupByLibrary.simpleMessage(
      "Этот код не является пригодной ссылкой на подписку. Отсканируйте другой.",
    ),
    "alwaysOnVpn": MessageLookupByLibrary.simpleMessage("Постоянный VPN"),
    "alwaysOnVpnDesc": MessageLookupByLibrary.simpleMessage(
      "Система сама поднимет VPN после перезагрузки или сбоя.",
    ),
    "alwaysOnVpnGuide": MessageLookupByLibrary.simpleMessage(
      "Этот переключатель находится в системных настройках: Настройки > Сеть и интернет > VPN > Clash MO > Постоянный VPN. Путь зависит от производителя.",
    ),
    "sniffer": MessageLookupByLibrary.simpleMessage("Определение доменов"),
    "snifferDesc": MessageLookupByLibrary.simpleMessage(
      "Распознаёт домены в трафике, чтобы правила срабатывали",
    ),
    "snifferOverrideDest": MessageLookupByLibrary.simpleMessage(
      "Использовать найденный домен как адрес назначения",
    ),
    "snifferOverrideDestDesc": MessageLookupByLibrary.simpleMessage(
      "Если выключено, домен нужен только для правил; адрес соединения прежний",
    ),
    "snifferForceDnsMapping": MessageLookupByLibrary.simpleMessage(
      "Повторно определять домен для трафика из DNS-сопоставления",
    ),
    "snifferForceDnsMappingDesc": MessageLookupByLibrary.simpleMessage(
      "Ещё раз проверяет трафик с доменом из DNS. Точнее",
    ),
    "snifferParsePureIp": MessageLookupByLibrary.simpleMessage(
      "Определять домен для трафика вообще без домена",
    ),
    "snifferParsePureIpDesc": MessageLookupByLibrary.simpleMessage(
      "Проверяет и соединения прямо по IP без домена",
    ),
    "snifferProtocols": MessageLookupByLibrary.simpleMessage(
      "Какие протоколы проверять",
    ),
    "snifferPorts": MessageLookupByLibrary.simpleMessage("порты"),
    "snifferPortsDesc": MessageLookupByLibrary.simpleMessage(
      "Пустой список — порты ядра по умолчанию",
    ),
    "snifferPortsDefault": MessageLookupByLibrary.simpleMessage(
      "Порты ядра по умолчанию",
    ),
    "snifferQuicDesc": MessageLookupByLibrary.simpleMessage(
      "На Android Chrome и другие используют QUIC. Без него домен неизвестен и правила не срабатывают",
    ),
    "snifferSkipDomain": MessageLookupByLibrary.simpleMessage(
      "Отбрасывать эти найденные домены",
    ),
    "snifferSkipDomainDesc": MessageLookupByLibrary.simpleMessage(
      "Если найден один из этих доменов — игнорировать",
    ),
    "snifferForceDomain": MessageLookupByLibrary.simpleMessage(
      "Всегда проверять эти домены",
    ),
    "snifferForceDomainDesc": MessageLookupByLibrary.simpleMessage(
      "Эти домены проверять всегда, что бы ни говорили другие настройки",
    ),
    "snifferSkipSrcAddress": MessageLookupByLibrary.simpleMessage(
      "Пропускать эти адреса источника",
    ),
    "snifferSkipSrcAddressDesc": MessageLookupByLibrary.simpleMessage(
      "Пропускать трафик из этих диапазонов",
    ),
    "snifferSkipDstAddress": MessageLookupByLibrary.simpleMessage(
      "Пропускать эти адреса назначения",
    ),
    "snifferSkipDstAddressDesc": MessageLookupByLibrary.simpleMessage(
      "Пропускать трафик в эти диапазоны",
    ),
    "lanAuth": MessageLookupByLibrary.simpleMessage(
      "Пароль для доступа из локальной сети",
    ),
    "lanAuthDesc": MessageLookupByLibrary.simpleMessage(
      "Спрашивать имя и пароль перед использованием вашего порта прокси",
    ),
    "lanAuthWarning": MessageLookupByLibrary.simpleMessage(
      "Доступ из локальной сети без пароля: любой в этой сети Wi-Fi может пользоваться прокси",
    ),
    "lanAuthEmpty": MessageLookupByLibrary.simpleMessage(
      "Учётные записи ещё не добавлены",
    ),
    "lanAuthLocalTip": MessageLookupByLibrary.simpleMessage(
      "Само устройство пароль не вводит — системный прокси работает",
    ),
    "userName": MessageLookupByLibrary.simpleMessage("Имя пользователя"),
    "skipAuthPrefixes": MessageLookupByLibrary.simpleMessage(
      "Адреса без пароля",
    ),
    "skipAuthPrefixesDesc": MessageLookupByLibrary.simpleMessage(
      "Эти диапазоны без пароля. Удалив адрес самого устройства, сломаете системный прокси",
    ),
    "externalControllerSecret": MessageLookupByLibrary.simpleMessage(
      "Ключ контроллера",
    ),
    "externalControllerSecretDesc": MessageLookupByLibrary.simpleMessage(
      "Нужен для API контроллера. Другие приложения устройства тоже могут к нему обратиться",
    ),
    "generateRandom": MessageLookupByLibrary.simpleMessage("Сгенерировать"),
    "notificationSpeed": MessageLookupByLibrary.simpleMessage(
      "Показывать скорость в уведомлении",
    ),
    "notificationSpeedDesc": MessageLookupByLibrary.simpleMessage(
      "Само уведомление остаётся, скрывается только строка со скоростью",
    ),
    "snifferFilters": MessageLookupByLibrary.simpleMessage("Исключения"),
    "lanAuthUserNameTip": MessageLookupByLibrary.simpleMessage(
      "Имя пользователя не может содержать двоеточие",
    ),
    "smartRoutingGlobalTip": MessageLookupByLibrary.simpleMessage(
      "В глобальном режиме выберите узел «Smart Group»",
    ),
    "smartModel": MessageLookupByLibrary.simpleMessage("Модель выбора"),
    "smartModelReady": MessageLookupByLibrary.simpleMessage("Готова"),
    "smartModelMissing": MessageLookupByLibrary.simpleMessage(
      "Не загружена, узлы пока выбираются по задержке",
    ),
    "smartModelDamaged": MessageLookupByLibrary.simpleMessage(
      "Файл неполный, загрузите заново",
    ),
    "smartModelNotReady": MessageLookupByLibrary.simpleMessage(
      "Модель не готова",
    ),
    "smartModelDownloading": MessageLookupByLibrary.simpleMessage("Загрузка…"),
    "smartModelDownloaded": MessageLookupByLibrary.simpleMessage(
      "Модель готова",
    ),
    "smartModelInvalid": MessageLookupByLibrary.simpleMessage(
      "Загружен неподходящий файл; прежняя модель сохранена",
    ),
    "smartLgbmAutoUpdate": MessageLookupByLibrary.simpleMessage(
      "Обновлять модель автоматически",
    ),
    "smartLgbmAutoUpdateDesc": MessageLookupByLibrary.simpleMessage(
      "Ядро само периодически скачивает новую модель",
    ),
    "smartLgbmWifiOnly": MessageLookupByLibrary.simpleMessage(
      "Только по Wi-Fi",
    ),
    "smartLgbmWifiOnlyDesc": MessageLookupByLibrary.simpleMessage(
      "Модель весит десятки МБ — не будет качаться через моб. трафик",
    ),
    "smartLgbmUpdateInterval": MessageLookupByLibrary.simpleMessage(
      "Интервал обновления",
    ),
    "smartLgbmUpdateIntervalDesc": MessageLookupByLibrary.simpleMessage(
      "Как часто проверять наличие новой модели",
    ),
    "smartLgbmUrl": MessageLookupByLibrary.simpleMessage("Адрес модели"),
    "smartLgbmUrlDesc": MessageLookupByLibrary.simpleMessage(
      "Пусто — встроенный адрес. Модель побольше точнее, но занимает больше места",
    ),
    "profileUpdateTimeoutTip": MessageLookupByLibrary.simpleMessage(
      "Время обновления подписки истекло — проверьте, работает ли адрес",
    ),
    "streamNeedRunningDesc": MessageLookupByLibrary.simpleMessage(
      "Прокси ещё не запущен — данные появятся здесь после запуска",
    ),
    "profileAutoUpdateFailedTip": m26,
    "backupEncryptTitle": MessageLookupByLibrary.simpleMessage(
      "Шифрование резервной копии",
    ),
    "backupEncryptDesc": MessageLookupByLibrary.simpleMessage(
      "Резервная копия содержит ссылки подписок и учётные данные WebDAV. Задайте пароль для шифрования; тот же пароль потребуется для восстановления. При утере пароля копию восстановить нельзя.",
    ),
    "restoreDecryptTitle": MessageLookupByLibrary.simpleMessage(
      "Введите пароль резервной копии",
    ),
    "restoreDecryptDesc": MessageLookupByLibrary.simpleMessage(
      "Эта резервная копия зашифрована. Введите пароль, заданный при её создании.",
    ),
    "restoreDecryptError": MessageLookupByLibrary.simpleMessage(
      "Неверный пароль или файл резервной копии повреждён",
    ),
    "insecureWebDAVWarning": MessageLookupByLibrary.simpleMessage(
      "Этот адрес использует незашифрованный HTTP, поэтому имя пользователя и пароль передаются по сети в открытом виде. Используйте HTTPS, если это не доверенная локальная сеть.",
    ),
    "smartModelSize": MessageLookupByLibrary.simpleMessage("Размер модели"),
    "smartModelSizeDesc": MessageLookupByLibrary.simpleMessage(
      "Чем больше модель, тем точнее выбор, но выше расход трафика и памяти",
    ),
    "smartModelSizeStandard": MessageLookupByLibrary.simpleMessage(
      "Стандартная",
    ),
    "smartModelSizeMiddle": MessageLookupByLibrary.simpleMessage("Средняя"),
    "smartModelSizeLarge": MessageLookupByLibrary.simpleMessage("Большая"),
    "smartModelSizeCustom": MessageLookupByLibrary.simpleMessage("Свой адрес"),
    "geoResourceNotDownloaded": MessageLookupByLibrary.simpleMessage(
      "Не загружено",
    ),
  };
}
