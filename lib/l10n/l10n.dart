...
class AppLocalizations {
  ...
  String get accessControlNotEnabledDesc {
    return Intl.message(
      'Not enabled yet. Changes here take effect once you turn it on.',
      name: 'accessControlNotEnabledDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Info mode`
  String get infoMode {
    return Intl.message('Info mode', name: 'infoMode', desc: '', args: []);
  }
  ...
  String get overrideDnsOffTip {
    return Intl.message(
      'While this is off, the settings below only apply when the subscription '
      'itself has no DNS section.',
      name: 'overrideDnsOffTip',
      desc: '',
      args: [],
    );
  }
  ...
  /// `ASN owner`
  String get asnOwner {
    return Intl.message('ASN owner', name: 'asnOwner', desc: '', args: []);
  }
  ...
  /// `Registry`
  String get registry {
    return Intl.message('Registry', name: 'registry', desc: '', args: []);
  }
  ...
  String get peakSpeed {
    return Intl.message('Peak speed', name: 'peakSpeed', desc: '', args: []);
  }
  ...
  String get releaseMemoryDesc {
    return Intl.message(
      'Ask the core to reclaim memory now',
      name: 'releaseMemoryDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `By latency`
  String get smartRoutingOff {
    return Intl.message(
      'By latency',
      name: 'smartRoutingOff',
      desc: '',
      args: [],
    );
  }
  ...
  /// `All traffic`
  String get vpnStateOn {
    return Intl.message('All traffic', name: 'vpnStateOn', desc: '', args: []);
  }
  ...
  /// `Off`
  String get tileStateOff {
    return Intl.message('Off', name: 'tileStateOff', desc: '', args: []);
  }

  /// `On`
  String get tileStateOn {
    return Intl.message('On', name: 'tileStateOn', desc: '', args: []);
  }

  /// `Smart Core`
  String get smartCore {
    return Intl.message('Smart Core', name: 'smartCore', desc: '', args: []);
  }

  /// `Turns the groups in your subscription into Smart groups, so the core picks nodes from past performance`
  String get smartRoutingDetail {
    return Intl.message(
      'Turns the groups in your subscription into Smart groups, so the core picks nodes from past performance',
      name: 'smartRoutingDetail',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Use LightGBM`
  String get smartUseLightGBM {
    return Intl.message(
      'Use LightGBM',
      name: 'smartUseLightGBM',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartUseLightGBMDesc {
    return Intl.message(
      'Picks nodes with a pre-trained model. Usually more accurate, but may not fit your network',
      name: 'smartUseLightGBMDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Collect Data`
  String get smartCollectData {
    return Intl.message(
      'Collect Data',
      name: 'smartCollectData',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartCollectDataDesc {
    return Intl.message(
      'Records how you use the network, to train your own model. Leave off if you won\'t train one',
      name: 'smartCollectDataDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartCollectorSize {
    return Intl.message(
      'Data Collection File Size',
      name: 'smartCollectorSize',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartCollectorSizeDesc {
    return Intl.message(
      'How large the record file may grow',
      name: 'smartCollectorSizeDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartStrategyDesc {
    return Intl.message(
      'Sticky sessions keep one site on one node; round robin rotates between candidates',
      name: 'smartStrategyDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sticky Sessions`
  String get smartStrategyStickySessions {
    return Intl.message(
      'Sticky Sessions',
      name: 'smartStrategyStickySessions',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Round Robin`
  String get smartStrategyRoundRobin {
    return Intl.message(
      'Round Robin',
      name: 'smartStrategyRoundRobin',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartToleranceDesc {
    return Intl.message(
      'Delays within this many ms count as equally fast, so nodes stop flip-flopping. 0 = off',
      name: 'smartToleranceDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartPreferAsnDesc {
    return Intl.message(
      'One extra lookup of which operator the destination belongs to, so Smart learns better. Slightly slower',
      name: 'smartPreferAsnDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Data Sample Rate`
  String get smartSampleRate {
    return Intl.message(
      'Data Sample Rate',
      name: 'smartSampleRate',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartSampleRateDesc {
    return Intl.message(
      'Records only a share of the data so the file grows slower. 1 records everything; it does not affect node choice',
      name: 'smartSampleRateDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartSampleRateTip {
    return Intl.message(
      'Enter a number greater than 0 and up to 1',
      name: 'smartSampleRateTip',
      desc: '',
      args: [],
    );
  }
  ...
  String get milliseconds {
    return Intl.message('ms', name: 'milliseconds', desc: '', args: []);
  }

  /// `This code is not a usable subscription link. Try another one.`
  String get scanUnrecognizedTip {
    return Intl.message(
      'This code is not a usable subscription link. Try another one.',
      name: 'scanUnrecognizedTip',
      desc: '',
      args: [],
    );
  }
  ...
  String get alwaysOnVpnGuide {
    return Intl.message(
      'This switch lives in the system settings: Settings > Network & internet > VPN > Clash MO > Always-on VPN. The exact path differs between phone makers.',
      name: 'alwaysOnVpnGuide',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Domain sniffing`
  String get sniffer {
    return Intl.message('Domain sniffing', name: 'sniffer', desc: '', args: []);
  }
  ...
  String get snifferOverrideDest {
    return Intl.message(
      'Use the sniffed domain as the destination',
      name: 'snifferOverrideDest',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferOverrideDestDesc {
    return Intl.message(
      'When off, the domain only matches rules; the connection keeps the original address',
      name: 'snifferOverrideDestDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferForceDnsMapping {
    return Intl.message(
      'Sniff DNS-mapped traffic again',
      name: 'snifferForceDnsMapping',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferForceDnsMappingDesc {
    return Intl.message(
      'Checks again on traffic whose domain came from DNS. More accurate',
      name: 'snifferForceDnsMappingDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferParsePureIp {
    return Intl.message(
      'Sniff traffic that has no domain at all',
      name: 'snifferParsePureIp',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferParsePureIpDesc {
    return Intl.message(
      'Also checks connections made straight to an IP with no domain',
      name: 'snifferParsePureIpDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sniffed protocols`
  String get snifferProtocols {
    return Intl.message(
      'Sniffed protocols',
      name: 'snifferProtocols',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferPortsDesc {
    return Intl.message(
      'Leave the list empty to use the kernel\'s default ports',
      name: 'snifferPortsDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferPortsDefault {
    return Intl.message(
      'Kernel default ports',
      name: 'snifferPortsDefault',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferQuicDesc {
    return Intl.message(
      'Chrome and others use QUIC by default on Android. Without it their domains stay unknown and rules miss',
      name: 'snifferQuicDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferSkipDomain {
    return Intl.message(
      'Discard these sniffed domains',
      name: 'snifferSkipDomain',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferSkipDomainDesc {
    return Intl.message(
      'If the detected domain is one of these, ignore it',
      name: 'snifferSkipDomainDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferForceDomain {
    return Intl.message(
      'Always sniff these domains',
      name: 'snifferForceDomain',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferForceDomainDesc {
    return Intl.message(
      'Always check these domains, whatever other settings say',
      name: 'snifferForceDomainDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferSkipSrcAddress {
    return Intl.message(
      'Skip these source addresses',
      name: 'snifferSkipSrcAddress',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferSkipSrcAddressDesc {
    return Intl.message(
      'Skip traffic coming from these ranges',
      name: 'snifferSkipSrcAddressDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferSkipDstAddress {
    return Intl.message(
      'Skip these destination addresses',
      name: 'snifferSkipDstAddress',
      desc: '',
      args: [],
    );
  }
  ...
  String get snifferSkipDstAddressDesc {
    return Intl.message(
      'Skip traffic going to these ranges',
      name: 'snifferSkipDstAddressDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get lanAuthLocalTip {
    return Intl.message(
      'This device never enters the password, so the system proxy keeps working',
      name: 'lanAuthLocalTip',
      desc: '',
      args: [],
    );
  }
  ...
  String get skipAuthPrefixes {
    return Intl.message(
      'Addresses exempt from the password',
      name: 'skipAuthPrefixes',
      desc: '',
      args: [],
    );
  }
  ...
  String get skipAuthPrefixesDesc {
    return Intl.message(
      'These ranges skip the password. Removing this device\'s own address breaks the system proxy',
      name: 'skipAuthPrefixesDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get externalControllerSecretDesc {
    return Intl.message(
      'Needed to call the controller API. Other apps on this device can reach it too',
      name: 'externalControllerSecretDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get generateRandom {
    return Intl.message('Generate', name: 'generateRandom', desc: '', args: []);
  }

  /// `Show speed in the notification`
  String get notificationSpeed {
    return Intl.message(
      'Show speed in the notification',
  ...
  String get notificationSpeedDesc {
    return Intl.message(
      'The notification itself always stays; only the speed line is hidden',
      name: 'notificationSpeedDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get lanAuthUserNameTip {
    return Intl.message(
      'The username cannot contain a colon',
      name: 'lanAuthUserNameTip',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartRoutingGlobalTip {
    return Intl.message(
      'In Global mode, select the "Smart Group" node',
      name: 'smartRoutingGlobalTip',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Ready`
  String get smartModelReady {
    return Intl.message('Ready', name: 'smartModelReady', desc: '', args: []);
  }

  /// `Not downloaded yet, so nodes are picked by latency for now`
  String get smartModelMissing {
    return Intl.message(
      'Not downloaded yet, so nodes are picked by latency for now',
      name: 'smartModelMissing',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartModelDamaged {
    return Intl.message(
      'File is incomplete, download it again',
      name: 'smartModelDamaged',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Model not ready`
  String get smartModelNotReady {
    return Intl.message(
      'Model not ready',
      name: 'smartModelNotReady',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Downloading…`
  String get smartModelDownloading {
    return Intl.message(
      'Downloading…',
      name: 'smartModelDownloading',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Model is ready`
  String get smartModelDownloaded {
    return Intl.message(
      'Model is ready',
      name: 'smartModelDownloaded',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartModelInvalid {
    return Intl.message(
      'What was downloaded is not a usable model; the old one was kept',
      name: 'smartModelInvalid',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartLgbmAutoUpdate {
    return Intl.message(
      'Update the model automatically',
      name: 'smartLgbmAutoUpdate',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartLgbmAutoUpdateDesc {
    return Intl.message(
      'Lets the core fetch a newer model on its own',
      name: 'smartLgbmAutoUpdateDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Only on Wi-Fi`
  String get smartLgbmWifiOnly {
    return Intl.message(
      'Only on Wi-Fi',
      name: 'smartLgbmWifiOnly',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartLgbmWifiOnlyDesc {
    return Intl.message(
      'The model is tens of megabytes; this keeps it off your data plan',
      name: 'smartLgbmWifiOnlyDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Update interval`
  String get smartLgbmUpdateInterval {
    return Intl.message(
      'Update interval',
      name: 'smartLgbmUpdateInterval',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartLgbmUpdateIntervalDesc {
    return Intl.message(
      'How often to look for a newer model',
      name: 'smartLgbmUpdateIntervalDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Model URL`
  String get smartLgbmUrl {
    return Intl.message('Model URL', name: 'smartLgbmUrl', desc: '', args: []);
  }

  /// `Leave empty for the built-in one. Bigger models are more accurate but take more space`
  String get smartLgbmUrlDesc {
    return Intl.message(
      'Leave empty for the built-in one. Bigger models are more accurate but take more space',
      name: 'smartLgbmUrlDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get profileUpdateTimeoutTip {
    return Intl.message(
      'Updating the subscription timed out; check whether the address still works',
      name: 'profileUpdateTimeoutTip',
      desc: '',
      args: [],
    );
  }
  ...
  String get streamNeedRunningDesc {
    return Intl.message(
      'The proxy is not running yet; data shows up here once you start it',
      name: 'streamNeedRunningDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String profileAutoUpdateFailedTip(Object label) {
    return Intl.message(
      '"$label" keeps failing to auto-update; the subscription address may be dead — sync it by hand or replace it',
      name: 'profileAutoUpdateFailedTip',
      desc: '',
      args: [label],
    );
  }
  ...
  String get backupEncryptDesc {
    return Intl.message(
      'The backup contains your subscription links and WebDAV credentials. Set a password to encrypt it; you will need the same password to restore. If you lose it, the backup cannot be recovered.',
      name: 'backupEncryptDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get restoreDecryptTitle {
    return Intl.message(
      'Enter backup password',
      name: 'restoreDecryptTitle',
      desc: '',
      args: [],
    );
  }
  ...
  String get restoreDecryptDesc {
    return Intl.message(
      'This backup is encrypted. Enter the password set when it was created.',
      name: 'restoreDecryptDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get restoreDecryptError {
    return Intl.message(
      'Wrong password or the backup file is corrupted',
      name: 'restoreDecryptError',
      desc: '',
      args: [],
    );
  }
  ...
  String get insecureWebDAVWarning {
    return Intl.message(
      'This address uses plaintext HTTP, so your username and password travel over the network unencrypted. Use HTTPS unless this is a trusted local network.',
      name: 'insecureWebDAVWarning',
      desc: '',
      args: [],
    );
  }
  ...
  String get smartModelSizeDesc {
    return Intl.message(
      'Bigger models pick better routes but cost more download and memory',
      name: 'smartModelSizeDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Standard`
  String get smartModelSizeStandard {
    return Intl.message(
      'Standard',
      name: 'smartModelSizeStandard',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Medium`
  String get smartModelSizeMiddle {
    return Intl.message(
      'Medium',
      name: 'smartModelSizeMiddle',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Large`
  String get smartModelSizeLarge {
    return Intl.message(
      'Large',
      name: 'smartModelSizeLarge',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Custom URL`
  String get smartModelSizeCustom {
    return Intl.message(
      'Custom URL',
      name: 'smartModelSizeCustom',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Not downloaded`
  String get geoResourceNotDownloaded {
    return Intl.message(
      'Not downloaded',
      name: 'geoResourceNotDownloaded',
      desc: '',
      args: [],
    );
  }
